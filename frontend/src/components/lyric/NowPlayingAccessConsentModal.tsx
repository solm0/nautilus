      ...
      <div className="flex flex-col gap-6 md:pb-3">
        <div className="flex flex-col gap-3">
          ...
          <p className="pr-8 text-sm text-neutral-600">
            {t("Nautilus uses Android notification access only to read the current song and player. It sends the song title and artist to LRCLIB to find lyrics. You can keep using other features without allowing access.")}
          </p>
          <a
