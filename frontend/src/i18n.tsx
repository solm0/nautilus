...
const translations: Record<AppLocale, Record<string, string>> = {
  ...
  ko: {
    ...
    "Add your thoughts in {language}...": "{language}로 생각을 적어보세요...",
    ...
    "Loading articulation...": "조음 정보를 불러오는 중...",
    "Loading...": "불러오는 중...",
    ...
    "Articulation SVG assets could not be loaded.": "조음 SVG 리소스를 불러오지 못했습니다.",
    "Articulation data could not be loaded.": "조음 정보를 불러오지 못했습니다.",
    "articulation": "조음",
    "voiced": "유성음",
    "voiceless": "무성음",
    "bilabial": "양순음",
    ...
    "glottal": "성문음",
    "labial-velar": "순연구개음",
    "labial-palatal": "순경구개음",
    "plosive": "파열음",
    "nasal": "비음",
    "trill": "전동음",
    "tap": "탄음",
    "fricative": "마찰음",
    "lateral_fricative": "설측 마찰음",
    "approximant": "접근음",
    "lateral_approximant": "설측 접근음",
    "front": "전설",
    "central": "중설",
    "back": "후설",
    "close": "고모음",
    ...
    "Your data will all disappear. Pages, annotations, comments, mutuals, and saved language data will be removed permanently.": "모든 데이터가 사라집니다. 페이지, 주석, 댓글, 이웃, 저장된 언어 데이터가 영구적으로 삭제됩니다.",
